    ...
    */
    public function updateDataAction(Request $request)
    {
        ...
        foreach ($results as $result) {
            ...
            $productList .= '<li id="'.$result['name'].'"><a href="http://localhost/symfony/projet-e-commerce3/web/app_dev.php/produit/'.$result['id'] .'">'.$matchStringBold.'</a></li>'; // Create the matching list - we put maching name in the ID too
        }
        $productList .= '</ul>';
        $response = new JsonResponse(['productList' => $productList]);
